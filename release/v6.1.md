...
- **Validation checklist**: Added a post-change validation rule (`.github/copilot-rules/validation.md`) requiring SonarQube analysis, pylint, and pytest to pass before considering a task complete.
